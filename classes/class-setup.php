...
class Setup {
	...
	public function __construct( $plugin_url, Batch_Ctrl $batch_ctrl, Batch_History_Ctrl $batch_history_ctrl, Settings_Ctrl $settings_ctrl, Options_Ctrl $options_ctrl) {		
